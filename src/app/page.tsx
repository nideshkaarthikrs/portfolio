    ...
    <>
      ...
      <Section id="blog" title="Blog / Posts">
        <p className="text-slate-300">
          I write about projects, startup lessons, and learning AI systems.
        </p>
        <Link
          href="/blog"
          className="mt-4 inline-flex rounded-full border border-white/20 px-5 py-2 text-sm hover:border-indigo-300 hover:text-indigo-200"
        >
          Explore posts
        </Link>
      </Section>
